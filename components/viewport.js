  ...
  render() {
    this.shadowRoot.innerHTML = `
      <style>
        ...
        ::slotted(activity-bar[orientation="top"]) {
          grid-area: top-bar;
        }
        ::slotted(activity-bar[orientation="right"]) {
          grid-area: right-bar;
        }
        ::slotted(activity-bar[orientation="bottom"]) {
          grid-area: bottom-bar;
        }
        ::slotted(activity-bar[orientation="left"]) {
          grid-area: left-bar;
        }
